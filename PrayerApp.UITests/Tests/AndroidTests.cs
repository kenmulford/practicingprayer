...
public class AndroidTests
{
    ...
    public void HardwareBack_DirtyDetail_ShowsDiscardDialog()
    {
        ...
        Thread.Sleep(TestConfig.DelayAfterNavigation); // Allow IsDirty to register the change

        driver.GoBack();
        Thread.Sleep(TestConfig.DelayCollectionRender); // Allow dialog animation to complete
